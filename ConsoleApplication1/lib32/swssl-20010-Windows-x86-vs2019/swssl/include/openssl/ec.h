...
# define EC_PKEY_IS_SM2_KEY      0x004
# define EC_PKEY_NEED_SM3_CTRL   0x008
...
# define  EVP_PKEY_CTX_set_server(ctx, server)        \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1,  \
                                  EVP_PKEY_CTRL_SET_SERVER, server, NULL)

# define  EVP_PKEY_CTX_set_enc_key(ctx, key)        \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1,  \
                                  EVP_PKEY_CTRL_SET_ECN_KEY, 0, (void *)(key))

# define  EVP_PKEY_CTX_set_peer_enc_pub(ctx, key)        \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1,  \
                                  EVP_PKEY_CTRL_SET_PEER_ENC_PUB, 0, (void *)(key))

# define  EVP_PKEY_CTX_set_ec_encrypt_param(ctx, param)        \
        EVP_PKEY_CTX_ctrl(ctx, EVP_PKEY_EC, EVP_PKEY_OP_ENCRYPT | EVP_PKEY_OP_DECRYPT,  \
...
# define EVP_PKEY_CTRL_SET_SERVER                        (EVP_PKEY_ALG_CTRL + 14)
# define EVP_PKEY_CTRL_SET_ECN_KEY                       (EVP_PKEY_ALG_CTRL + 15)
# define EVP_PKEY_CTRL_SET_PEER_ENC_PUB                  (EVP_PKEY_ALG_CTRL + 16)
# define EVP_PKEY_CTRL_EC_ENCRYPT_PARAM                  (EVP_PKEY_ALG_CTRL + 17)
